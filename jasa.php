  ...
  <div class="container">
    <div class="products">
      ...
      <div class="product-list">
        <div
          class="product-item"
          onclick="window.location.href='tukusujasa.html'"
        >
          <img
            alt="RC Car"
            height="200"
            src="https://storage.googleapis.com/a1aa/image/OipuXdfeNuvlrEDYPJCceJSwNUQpndRZPHwj0IsnTIxoP6NnA.jpg"
            width="200"
          />
          <div class="user-info">
            <img
          ...
          <p>Jasa kocok rekal dengan kecepatan 50 magnitudo</p>
          <h4>jasa kocok</h4>
